...
function LeftSection_2() {
    return (
      ...
      <Container fixed >
          <Container maxWidth ="md" fixed >
              <div className="row">
                  <div className="text-center col-6 h3 mx-auto my-4 font-weight-bold">Idea Collection</div>
                  <div className=" text-left col-12 row mt-4">
                      <div className="col-6">
                          <div>
...
function LeftSection_3() {
    return (
      ...
      <Container fixed >
          <Container maxWidth ="md" fixed >
              <div className="row">
                  <div className="text-center col-6 h3 mx-auto my-4 font-weight-bold">Idea Evaluation</div>
                  <div className=" text-left col-12 row mt-4">
...
function LeftSection_4() {
    return (
      ...
      <Container fixed >
          <Container maxWidth ="md" fixed >
              <div className="row">
                  <div className="text-center col-6 h3 mx-auto my-4 font-weight-bold">Reporting and Analytics</div>
                  <div className=" text-left col-12 row mt-4">
                      <div className="col-6">
                          <div>
...
function RightSection_1() {
    return (
      ...
      <Container fixed >
          <Container maxWidth ="md" fixed >
                <div className="row">
                    <div className="text-center col-6 h3 mx-auto mb-4 font-weight-bold">Manage Challenges</div>
                    <div className=" text-left col-12 row mt-4">
                        <div className="col-6">
...
function RightSection_2() {
    return (
      ...
      <Container fixed >
          <Container maxWidth ="md" fixed >
                <div className="row">
                    <div className="text-center col-6 h3 mx-auto mb-4 font-weight-bold">Idea Voting</div>
                    <div className=" text-left col-12 row mt-4">
                        <div className="col-6">
...
function RightSection_3() {
    return (
      ...
      <Container fixed >
          <Container maxWidth ="md" fixed >
                <div className="row">
                    <div className="text-center col-6 h3 mx-auto mb-4 font-weight-bold">Idea Realization</div>
                    <div className=" text-left col-12 row mt-4">
                        <div className="col-6">
...
function RightSection_4() {
    return (
      ...
      <Container fixed >
          <Container maxWidth ="md" fixed >
                <div className="row">
                    <div className="text-center col-6 h3 mx-auto mb-4 font-weight-bold">Setup and Configuration</div>
                    <div className=" text-left col-12 row mt-4">
                        <div className="col-6">
